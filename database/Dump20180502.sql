...
CREATE TABLE `car` (
  ...
  `car_capacity` varchar(45) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `user_contactNumber` varchar(200) NOT NULL,
  `user_complete` varchar(145) NOT NULL,
  `user_type` enum('master','type') NOT NULL,
...
-- Dump completed on 2018-05-02 14:24:08
